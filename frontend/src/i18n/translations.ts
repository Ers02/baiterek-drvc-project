export const translations = {
  ru: {
    ...
    create_new_version: 'Внести корректировки',
      ...
      <ol>
        ...
        <li><b>Заполните данные:</b> Откройте скачанный шаблон и заполните необходимые поля. Обратите внимание на следующие моменты:
          <ul>
            ...
            <li><b>Код АГСК:</b> Для позиций с "Статьей затрат" = "СМР" (Строительно-монтажные работы) поле "Код АГСК (для СМР)" является обязательным. Если нет АГСК-3 то укажите <b>прайс-лист</b></li>
            <li><b>Формат чисел:</b> Количество, цена и сумма должны быть указаны в числовом формате.</li>
            <li><b>Доля внутристрановой ценности:</b> Указывается для услуг и работ в числовом виде до 100, если меньше 100 то обязательно указываете обоснование.</li>
          </ul>
        </li>
